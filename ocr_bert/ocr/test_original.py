...
def init_ocr_model():
    ...
    detection_pb = './checkpoint/ICDAR_0.7.pb' # './ocr/checkpoint/ICDAR_0.7.pb'
...
# # p = multiprocessing.Process(init_ocr_model())
# # p.start()
# # p.join()
...
img_path = "/home/sohne/PycharmProjects/chinese_software_competition/ocr/image/images/"+str(i)+".jpg"
save_path = "/home/sohne/PycharmProjects/chinese_software_competition/ocr/image/test_img/"+str(i)+".jpg"
ocr_img(img_path,save_path,ocr_detection_model, ocr_recognition_model, ocr_label_dict)
