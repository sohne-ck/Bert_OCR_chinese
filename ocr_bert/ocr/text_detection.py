...
class TextDetection(object):
    ...
    def init_model(self):
        ...
        self.sess = tf.compat.v1.Session(graph=self.graph, config=self.config)
    ...
    def predict(self, bgr_image):
        ...
        boxes, scores, labels, masks = self.sess.run([self.boxes_ph, self.scores_ph, self.labels_ph, self.masks_ph],feed_dict={self.img_ph: resized_img})
